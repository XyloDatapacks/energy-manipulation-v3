...
public class ContinueInstructionNode extends AbstractNodeWithMap implements InstructionNode {
    
    public ContinueInstructionNode() {
        super(Nodes.INSTRUCTION_CONTINUE);
    }
    ...
    public boolean executeInstruction(SpellExecutor spellExecutor) {
        spellExecutor.getExecutionData().returnType = ReturnType.CONTINUE;
        return true;
    }
