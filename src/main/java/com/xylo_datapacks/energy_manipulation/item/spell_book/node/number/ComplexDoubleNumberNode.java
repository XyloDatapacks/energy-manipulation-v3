...
public class ComplexDoubleNumberNode extends AbstractNodeWithMap implements NumberNode, DoubleNumberNode, StringNode {
    ...
    public String getString(SpellExecutor spellExecutor) {
        return String.valueOf(getDoubleNumber(spellExecutor));
    }
